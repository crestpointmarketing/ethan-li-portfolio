    ...
    <div className="min-h-screen pt-20">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-16 py-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-[#08874a] dark:text-[#16A34A]">Internship Project | Real-Time Human-AI Interaction System</p>

          {/* Key Metrics */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
              <div className="text-4xl font-bold text-[#08874a] dark:text-[#16A34A] mb-2">Live</div>
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
              <div className="text-4xl font-bold text-[#08874a] dark:text-[#16A34A] mb-2 whitespace-nowrap">Multi-format</div>
              <div className="text-sm text-[var(--muted-foreground)]">Interview Engines</div>
            </div>
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
              <div className="text-4xl font-bold text-[#08874a] dark:text-[#16A34A] mb-2 whitespace-nowrap">LLM-powered</div>
        ...
        <div className="mb-16">
          ...
          >
            <iframe
              ...
              src="https://www.youtube.com/embed/BwW6pBthVPc"
        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8 space-y-4">
              <p className="text-[var(--foreground)]/90 leading-relaxed">
                ...
                Studies show that <span className="text-[#08874a] dark:text-[#16A34A] font-medium">up to 93% of job seekers</span> experience
              ...
              <p className="text-[var(--foreground)]/90 leading-relaxed">
                <span className="text-[#08874a] dark:text-[#16A34A] font-medium">Eelocutionist democratizes interview preparation</span> by
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">AI Interview Engine Architecture</h3>
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">LLM-Based Evaluation Framework</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed mb-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-[var(--card)] border border-white/5 rounded-lg p-4">
                    <h5 className="text-sm font-medium text-[#08874a] dark:text-[#16A34A] mb-2">Content Quality</h5>
                    <p className="text-xs text-[var(--muted-foreground)]">Relevance, depth, and accuracy of responses</p>
                  </div>
                  <div className="bg-[var(--card)] border border-white/5 rounded-lg p-4">
                    <h5 className="text-sm font-medium text-[#08874a] dark:text-[#16A34A] mb-2">Communication Clarity</h5>
                    <p className="text-xs text-[var(--muted-foreground)]">Articulation, coherence, and persuasiveness</p>
                  </div>
                  <div className="bg-[var(--card)] border border-white/5 rounded-lg p-4">
                    <h5 className="text-sm font-medium text-[#08874a] dark:text-[#16A34A] mb-2">Behavioral Fit</h5>
                    <p className="text-xs text-[var(--muted-foreground)]">Alignment with target company culture and role</p>
                  </div>
                  <div className="bg-[var(--card)] border border-white/5 rounded-lg p-4">
                    <h5 className="text-sm font-medium text-[#08874a] dark:text-[#16A34A] mb-2">Improvement Areas</h5>
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Real-Time Interaction System</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed">
                  Built with <span className="text-[#08874a] dark:text-[#16A34A] font-medium">Express.js backend</span> and integrated speech
                  APIs, the platform delivers <span className="text-[#08874a] dark:text-[#16A34A] font-medium">conversational, real-time</span> interview
          ...
          <section>
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8 space-y-4">
              <p className="text-[var(--foreground)]/90 leading-relaxed">
                Eelocutionist is fundamentally a <span className="text-[#08874a] dark:text-[#16A34A] font-medium">human-AI collaboration system</span>,
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Tech Stack</h3>
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                ...
                <p className="text-[var(--foreground)]/90 leading-relaxed mt-4">
                  ...
                  but Eelocutionist's <span className="text-[#08874a] dark:text-[#16A34A] font-medium">AI-powered unlimited practice model</span> offers
                  superior scalability and accessibility.
                </p>
              </div>

              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Production Deployment</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed">
                  As an <span className="text-[#08874a] dark:text-[#16A34A] font-medium">internship project deployed to production</span>,
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Career Impact</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#08874a] dark:bg-[#16A34A] mt-2 flex-shrink-0" />
                    <div>
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Research Contributions</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed mb-4">
              ...
              <div className="bg-gradient-to-br from-[#08874a]/10 dark:from-[#16A34A]/10 to-transparent border border-[#08874a]/30 dark:border-[#16A34A]/30 rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Real-World Validation</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed">
                  Deployed as a <span className="text-[#08874a] dark:text-[#16A34A] font-medium">live production platform</span>, Eelocutionist
