    ...
    <div className="min-h-screen pt-20">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-16 py-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-[#08874a] dark:text-[#16A34A]">Real-Time AI System for Financial Market Analysis</p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
              <div className="text-4xl font-bold text-[#08874a] dark:text-[#16A34A] mb-2 whitespace-nowrap">LLM-based</div>
              <div className="text-sm text-[var(--muted-foreground)]">Reasoning Engine</div>
            </div>
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
              <div className="text-4xl font-bold text-[#08874a] dark:text-[#16A34A] mb-2">FastAPI</div>
              <div className="text-sm text-[var(--muted-foreground)]">Scalable Backend</div>
            </div>
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
              <div className="text-4xl font-bold text-[#08874a] dark:text-[#16A34A] mb-2">Docker</div>
        ...
        <div className="mb-16">
          ...
          >
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-center px-6">
              ...
              <p className="text-[var(--foreground)]/90 font-medium">Demo video coming soon</p>
              <p className="text-sm text-[var(--muted-foreground)]">Zeitgeist walkthrough is being recorded.</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8 space-y-4">
              <p className="text-[var(--foreground)]/90 leading-relaxed">
                ...
                systems excel at pattern recognition but struggle with <span className="text-[#08874a] dark:text-[#16A34A] font-medium">contextual
              ...
              <p className="text-[var(--foreground)]/90 leading-relaxed">
                <span className="text-[#08874a] dark:text-[#16A34A] font-medium">Zeitgeist explores whether LLMs can perform structured financial
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">LLM-Driven Financial Analysis Pipeline</h3>
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Uncertainty Quantification</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed">
                  A critical innovation is the system's ability to <span className="text-[#08874a] dark:text-[#16A34A] font-medium">reason under
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Scalable Architecture: FastAPI + Docker</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed mb-4">
                  The backend is built with <span className="text-[#08874a] dark:text-[#16A34A] font-medium">FastAPI</span> (Python async framework)
              ...
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Dynamic Market Adaptation</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed">
                  The system implements a <span className="text-[#08874a] dark:text-[#16A34A] font-medium">continuous inference pipeline</span> that
          ...
          <section>
            ...
            <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8 space-y-4">
              <p className="text-[var(--foreground)]/90 leading-relaxed">
                Effective financial AI requires deep <span className="text-[#08874a] dark:text-[#16A34A] font-medium">quantitative finance and
          ...
          <section>
            ...
            <div className="space-y-6">
              <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Financial Market Impact</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#08874a] dark:bg-[#16A34A] mt-2 flex-shrink-0" />
                    <div>
              ...
              <div className="bg-gradient-to-br from-[#08874a]/10 dark:from-[#16A34A]/10 to-transparent border border-[#08874a]/30 dark:border-[#16A34A]/30 rounded-xl p-8">
                <h3 className="text-xl font-semibold text-[#08874a] dark:text-[#16A34A] mb-4">Independent Exploration</h3>
                <p className="text-[var(--foreground)]/90 leading-relaxed">
                  As an <span className="text-[#08874a] dark:text-[#16A34A] font-medium">independent research project</span>, Zeitgeist demonstrates
